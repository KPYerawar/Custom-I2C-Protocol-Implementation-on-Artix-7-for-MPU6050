...
HD_PWD='/home/krushna_dev/all_verilog_codes/vivado/I2C interface/i2c_v2019/i2c_v2019.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_master1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_master1.tcl -notrace
